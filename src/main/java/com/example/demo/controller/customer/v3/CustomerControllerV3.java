package com.example.demo.controller.customer.v3;
...
@Validated
public class CustomerControllerV3 extends BaseController {
    ...
    @Timed
    public ResponseEntity<Response<CustomerResponse>> findById2(@PathVariable final Long id,
